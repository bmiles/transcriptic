...
class Instructions(object):
    ...
    raw_instructions : dict
       Dictionary of raw instructions.
    ...
    raw_instructions : dict
        Dictionary of raw instructions.
    df : DataFrame
        Pandas DataFrame composed of each instruction's name and its
        associated list of warps.
...
class Project(object):
  ...
  def data(self):
    ...
    def monitoring(self, instruction_id, data_type = 'pressure'):
        '''
        Returns a pandas DataFrame containing the monitoring data of the
        specified `data_type` for an `instruction_id`

        Parameters
        ----------
        instruction_id : str
            ID of instruction for which to retrieve monitoring data
        data_type : str
            Type of data to retrieve (ex: `"pressure"`)
    ...
    def data(self):
        '''
        Returns a DataSet object containing data generated by the Run object.
...
class Project(object):
    ...
    def runs(self):
        '''
        Return the list of Run objects that exist in a Project
    ...
    def submit(protocol, title, test_mode = False):
        '''
        Submit a Autoprotocol-formatted JSON object to a Project.

        Parameters
        ----------
        protocol : dict
            Protocol to submit to the Project.
        title : str
            Title of the run to be submitted.
        test_mode : bool
            Boolean indicating whether to submit the run in test mode.

        Returns
        -------
        run : Run
            Run object with associated generated run id and protocol JSON.
